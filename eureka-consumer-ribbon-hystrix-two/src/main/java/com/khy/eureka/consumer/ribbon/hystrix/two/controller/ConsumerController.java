package com.khy.eureka.consumer.ribbon.hystrix.two.controller;
...
public class ConsumerController {
    ...
    @ResponseBody
    public String d0() throws InterruptedException {
        Thread.sleep(5000);
    ...
    @HystrixCommand(fallbackMethod = "fallback")
    @ResponseBody
    public String d1() throws InterruptedException {
        Thread.sleep(5000);
        String url = "http://eureka-client" + "/index?name=khy";
        System.out.println(url);
        return restTemplate.getForObject(url, String.class);
    ...
    @HystrixCommand(fallbackMethod = "fallback")
    @ResponseBody
    public String d2() throws InterruptedException {
        String url = "http://eureka-client" + "/index?name=khy";
        System.out.println(url);
        return restTemplate.getForObject(url, String.class);
    }
    ...
    @HystrixCommand(fallbackMethod = "fallback")
    @ResponseBody
    public String d3() throws InterruptedException {
        String url = "http://eureka-client" + "/index?name=khy";
        System.out.println(url);
        return restTemplate.getForObject(url, String.class);
    }
